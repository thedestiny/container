			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form id="signup" method="post" class="form-horizontal"
						...
						<!--action="/bookedit" 表单默认提交自身控制器  -->
						<div class="form-group">
							<label class="col-sm-4 control-label" for="bookcode">Book
								code</label>
							<div class="col-sm-5">
								<input type="text" class="form-control  " id="bookcode" value = "${requestScope.book.code}"
									name="code" placeholder="Book code" readonly>
									<!--${requestScope.book.code} 和 ${book.code}  作用一样-->
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label" for="booktitle">Book
								title</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="booktitle" value = "${requestScope.book.title}"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="bookauthor">Book
								author</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="bookauthor" value = "${requestScope.book.author}"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="bookpress">Book
								press</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="bookpress" value = "${requestScope.book.press}"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="bookstation">Book
								station</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="bookstation" value = "${requestScope.book.station}"
