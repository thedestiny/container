                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu text-center" style="width: 150px; right:0;">
                        <li class="user-header" style="height: 80px">
                            <p>
                                I am Oliver Queen
                                <small>I live in Star City</small>
                            </p>
                        </li>
                        <li><a href="/user/log" class="text-center">查看日志</a></li>
                        <li><a href="/user/password" class="text-center">修改密码</a></li>
                        <li class="divider"><a href="#" class=" btn-flat"></a></li>
                        <li><a href="/signout" class="text-center">安全退出</a></li>
                    </ul>
                </li>
            </ul>
        </div>
